...
```shell script
go get -u github.com/kodesmil/gqlgenc
```
...
[clientgen](https://github.com/kodesmil/gqlgenc/tree/master/clientgen) is created based on [modelgen](https://github.com/99designs/gqlgen/tree/master/plugin/modelgen). So if you don't have a modelgen, it may be a mysterious move.
